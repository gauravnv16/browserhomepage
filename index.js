...
var bday = String("Oct 20 " + da);
var c = months[d.getMonth()] +" " +dy + " " +da;
var bs = document.getElementById("song")

if ((bday === c) || (bday === "Oct 202016")){
document.getElementById("demo").innerHTML = "Happy birthday Gaurav!!";
bs.play()
bs.volume = 0.5;
}
else{
  document.getElementById("demo").innerHTML = "Hello,Gaurav Reddy!"
}
